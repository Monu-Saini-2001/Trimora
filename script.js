...
function triggerVoiceCallAlert(token, waitTime){
  ...
  if (waitVal <= 0.1) {
    ...
    textHi = `नमस्ते! यह LUZOX से एक कॉल है। ${token.salonName} पर आपका अपॉइंटमेंट जल्द ही शुरू होने वाला है। आपकी प्रतीक्षा का समय ${waitMins} मिनट है, जो आपके यात्रा समय ${travelMins} मिनट के बराबर है। कृपया अभी निकलें। धन्यवाद!`;
  }
